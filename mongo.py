...
db = client.camp2018  # Select the database
todos = db.todo  # Select the collection

app = Flask(__name__)
title = "Reminder with Flask"
...
def completed():
    ...
    a3 = "active"
    return render_template('home.html', a3=a3, todos=todos_l, t=title, h=heading)
...
def search():
    ...
    return render_template('search.html', todos=todos_l, t=title, h=heading)
